...
$listDelete->insert(6);
$listDelete->insert(7);
$listDelete->getLikedList();
$listAlgo->setList($listDelete);
$listAlgo->deleteLastKth(3);
//var_dump($listAlgo->list->getLikedList());
echo '------------------------------------------------------------------'. PHP_EOL . PHP_EOL;
